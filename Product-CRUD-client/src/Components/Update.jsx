...
const Update = () => {
  ...
  useEffect(()=>{
    Axios.get(`http://127.0.0.1:5000/api/products/${selectedId}`)
    .then((response)=>{
  ...
  let updateHandler = (event) => {
    ...
    let url = `http://127.0.0.1:5000/api/products/${selectedId}`
                ...
                <div id='card-create' className="card">
                  ...
                  <div id='body-create' className="card-body">
                    <form onSubmit={updateHandler}>
                      <div id='head-create' className="form-group">
                      ...
                      <button id='btn-create' className="btn btn-warning">Update Product</button>
                    </form>
                  </div>
                </div>
              </div>
